    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="max-w-xl mb-5">
            <div class="relative">
                ...
                <x-input  type="search" placeholder="Search…" class="form-input w-full pl-9 py-3  focus:ring-blue-500 focus:border-blue-500" />
                <span class="absolute pr-3 pt-3.5 inset-0 right-auto  ">
