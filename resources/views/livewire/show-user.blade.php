            ...
            <tbody class="block md:table-row-group">
                @foreach ($usuarios as $user)
                    <tr
                        ...
                        <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                            ...
                            <div class=" flex justify-center">
                                ...
                                @if ($user->profile_photo_path)
                                    <a href="#" wire:click="edit({{ $user }})">
                                        <img class=" h-14 w-14 m-1 rounded-full object-cover object-center  relative "
                                            src="{{ asset('storage/' . $user->profile_photo_path) }}" alt="" />
                                    </a>
                                @else
                                    {{-- <img class=" h-10 w-10 m-1 rounded-full object-cover object-center  relative "
                                        src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
                                        alt="" /> --}}

                                    <a class="btn-sm bg-indigo-400 rounded-lg text-slate-700 hover:bg-indigo-500 hover:text-black"
                                        href="#" wire:click="edit({{ $user }})">
                        ...
                        <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                                class="inline-block w-1/3 md:hidden font-bold">Rol:</span>{{ $user->getRoleNames()->first() }}
                        </td>
            ...
            <div class="px-4 ">
                ...
                <div class="flex items-center">
                    <div class="m-3">
                        ...
                        @else
                            <a
                                class="btn-sm bg-indigo-500 rounded-lg text-slate-700">
            ...
            Livewire.on('deleteUser', userId => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('show-user', 'delete', userId);
                        Swal.fire(
                            'Eliminado!',
