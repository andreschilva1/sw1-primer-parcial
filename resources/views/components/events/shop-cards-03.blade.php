...
<div
    ...
    <div class="flex flex-col h-full">
        ...
        <div class="relative">
            @if ($event->photo_path)
                <img class="w-full" src="{{$event->photo_path}}" width="286" height="160"
                    alt="Application 09" />
            @else
        ...
        <div class="grow flex flex-col p-5">
            ...
            {{-- @livewire('fotos.subir-fotos', ['id' => $event->id]) --}}

            <div class="mb-4">
                <a {{-- wire:click=$set('openFoto',true) --}} wire:click="$emitTo('fotos.subir-fotos', 'motrarSubirFoto',{{$event->id}})"
